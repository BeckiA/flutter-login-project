...
import 'package:login_app/src/features/core/controllers/map_controllers/nearby_hotels_controller.dart';
...
class NearbyHotels extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    Get.put(NearbyHotelsController());
    return SafeArea(
      child: Scaffold(
        body: FutureBuilder(
          future: NearbyHotelsController.instance
              .getHotelMarkers(latitude, longitude, 5000), // 10km radius
          builder:
